...
class Industries extends CI_Controller {
	...
	public function index(){
		...
		$industry_row = $this->Industry->get_industries_by_slug($this->uri->segment(2));
	...
	public function industry_search($industry_id, $industry_slug){
		...
		$total_rows = $this->Posted_job->count_records_by_industry($industry_id);
		...
		$result = $this->Posted_job->job_search_by_industry($industry_id, $pagenation['per_page'],$pagenation['page']);
