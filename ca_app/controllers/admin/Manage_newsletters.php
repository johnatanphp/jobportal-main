...
class Manage_Newsletters extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Newsletter->record_count('tbl_newsletter');
		...
		$obj_result = $this->Newsletter->get_all_records($config["per_page"], $page);
	...
	public function get_record_by_id($id=''){
		if($id!=''){
			$row = $this->Newsletter->get_record_by_id($id);
	...
	public function add(){
		...
		$this->Newsletter->add($data_array);
	...
	public function update(){
		...
		$this->Newsletter->update($id, $data_array);
	...
	public function status($id='', $current_staus=''){
		...
		$this->Newsletter->update($id, $data);
		echo $new_status;
		exit;
	}	
	...
	public function delete($id=''){
		...
		$obj_row = $this->Newsletter->delete($id);
		echo 'done';
		exit;
	}
	...
	public function preview($id=''){
		...
		$obj_row = $this->Newsletter->get_record_by_id($id);
	...
	public function force_send_newsletter(){
		...
		$mail_message = $this->Email_drafts->force_send_newsletter_draft($email_draft);
