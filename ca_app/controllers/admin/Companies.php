...
class Companies extends CI_Controller {
    ...
    {
        $data['title'] = 'Gestionar compañías';
        $data['msg'] = '';
        ...
        //Pagination starts
        $total_rows = $this->Company->count_all_companies($filters);
        $config = pagination_configuration_search(base_url('admin/companies/search'), $total_rows, 25, 3, 5, true);
        ...
        $obj_result = $this->Company->search_all_companies($filters, $config["per_page"], $page);
        $data['result'] = $obj_result;
        $data['filter'] = $filters;

        $this->load->view('admin/companies/company_search_view', $data);
    }
    ...
    {       
        ...
        $obj_row = $this->Employer->get_employer_by_id($emp_id);
        ...
        */
        ...
        $this->Company->update_company($comp_id, $company_array);
        $this->session->set_flashdata('update_action', true);
        redirect('admin/employers/update/' . $emp_id);
    }
    ...
    {   
        ...
        $this->Company->update_company($id, $data);
