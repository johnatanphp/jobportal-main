<?php 
class Entry_form_data_show_ec_service
{
    ...
    public function get_data($process_id, $seeker_id)
    {
        ...
        $entry_form_mx = $this->Entry_form_ec->get_by_entry_form_id($entry_form->id);
        $rightful_claimants = $this->Entry_form_ec->get_rightful_claimants($entry_form->id);
