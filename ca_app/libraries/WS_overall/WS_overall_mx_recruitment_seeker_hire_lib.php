...
class WS_overall_mx_recruitment_seeker_hire_lib 
{   
    private $period_year;
    ...
    private function get_job_candidate_to_hire($process_id, $seeker_id)
    {
        ...
        $this->db->select([
            ...
            'entry_form_data.entry_form_id AS entry_form_id',
        ...
        $this->db->join('tbl_entry_form_mx entry_form_data', 'entry_form_data.entry_form_id=entry_form.id');
