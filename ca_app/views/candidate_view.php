      ...
      <div class="row"> 
        ...
        <div class="col-md-12">
          ...
          <div class="userinfoWrp">
            ...
            <div class="col-md-4">
              <div class="usercel"><?php echo country_text($row->country); ?> - <?php echo $row->city;?></div>
              <?php if($this->session->userdata('is_employer')==TRUE):?><a href="javascript:;" id="sendcandidatemsg" style="margin-top: 10px;" class="btn btn-primary btn-sm"><span>Enviar mensaje</span></a>
              <?php endif;?>
               </div>
            <div class="clear"></div>
          </div>
		  ...
		  ?>
            <li class="row" id="cv_<?php echo $row_resume->ID;?>">
              ...
              <?php if($row_resume->is_uploaded_resume): ?>
              	<a href="<?php echo base_url('resumes/download/'.$row_resume->ID);?>">Mi CV <small>(Descargar)</small></a>
              <?php else: ?>
			  	<a href="#">Mi CV</a>
			  <?php endif;?>
              </div>
        ...
        <div class="experiance">
          <?php 
			if($result_experience):
				...
				$date_to = ($row_experience->end_date) ? ucwords(_date_locale_format(strtotime($row_experience->end_date), 'MMM y')) : 'Presente';
		?>
          <div class="row expbox">
            <div class="col-md-12">
              ...
              <ul class="useradon">
                ...
                <?php endif;?>
                <li><?php echo ucwords(_date_locale_format(strtotime($row_experience->start_date), 'MMM y')); ?> - <?php echo $date_to;?></li>
              </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Enviar mensaje a <?php echo $row->first_name;?></h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="msg_submit" id="msg_submit" class="btn btn-primary">Enviar</button>
      </div>
    </div>
  </div>
</div>
