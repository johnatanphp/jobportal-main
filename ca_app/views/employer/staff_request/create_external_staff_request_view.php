  ...
  <div class="row">
    ...
    <div class="col-md-9"> 
      ...
      <div class="formwraper">
        <div class="titlehead">Crear solicitud externa</div>
          ...
          <div class="col-md-12">
            <div class="formint">    
              ...
              <div id="wrapper-steps">
                ...
                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_additional_benefits'); ?>
                </div>

                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_resources'); ?>
                </div>
                ...
                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_knowledges'); ?>
                </div>

                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_computing'); ?>
                </div>

                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_languages'); ?>
                </div>  

                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_job_functions'); ?>
                </div>
                
                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_competences'); ?>
                </div>

                <div class="content-step">
                  <?php $this->load->view('employer/staff_request/section_sr_external/section_additional_comments'); ?>
                </div>
...
<?php $this->load->view('employer/staff_request/scripts/create_sr_external'); ?>
</body>
</html>