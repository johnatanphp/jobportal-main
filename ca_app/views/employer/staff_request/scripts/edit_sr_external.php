...
$(function() {
  ...
  function validateDataRequest() {
    ...
    $( "#form-edit-request" ).get(0).submit();
  }
  ...
  function validateStep(step) {
    ...
    var data = $( '#form-edit-request' ).serialize() + "&_step=" + step;

    stepInputs.prop('disabled', true);    

    $( ".has-error" ).removeClass("has-error");
    $( ".info-error").remove();
    var url = "<?php echo site_url('employer/staff_request/edit_external_staff_request/validate_step'); ?>"; 
