                       ...
                       <div>
                                <div style="padding: 12px 0;">
                                   <div class="input-group">
                                        <label class="input-group-addon">Formulario <span></span></label>
                                        <select id="form-id" class="form-control" name="form_id" required="true" style="width: 100%;">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $( '#export' ).click(function() {
                ...
                if ($( '#form-id' ).val() == '') {
                    toastr["error"]("Debe seleccionar un formulario");
                    return;
                }

                val = $( 'input[name="date"]:checked' ).val();

                if (val == 'custom' && ($.trim($( '#start-date' ).val()) == '' || $.trim($( '#end-date' ).val()) == '')) {
                    toastr["error"]("Debe seleccionar fecha inicio y fecha final");
                    return;
                }
