<!-- Modal -->
<div id="modal-list-permission-clients" class="modal fade" role="dialog">
  <div class="modal-dialog" style="min-width: 70%;">
    <!-- Modal content-->
    <div class="modal-content" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Listado clientes disponibles</h4>
      </div>
      <div class="modal-body">
        <div style="padding: 10px 0;">
          <button id="btn-add-permisison-clients" class="btn btn-sm btn-success">Agregar</button>
        </div>
        <table id="tbl-list-permission-clients" class="table" width="100%">
          <thead>
              <tr>
...
$(function(){
  ...
  $( '#btn-add-permisison-clients' ).click(function(){
    ...
    const url = "<?php echo site_url('admin/job_layout_permissions/add_clients'); ?>";
  ...
  $( '#tbl-list-permission-clients' ).DataTable({
    ...
    "bProcessing": true,
    ajax: {
      url: "<?php echo site_url('admin/job_layout_permissions/clients'); ?>",
      type: 'GET',
      data: {
        job_layout_id: "<?php echo $job_layout->id; ?>"
      }
