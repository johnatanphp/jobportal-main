  ...
  <div class="row">
    ...
    <div class="col-md-9"><!--Job Detail-->
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-12"><b>Sugerencias de empleo</b></div>
          </div>
        </div>
        ...
        <?php if($result):
		      $CI =& get_instance();
                ...
                //($row->company_logo)?$row->company_logo:'no_logo.jpg';
								$is_already_applied = $CI->is_already_applied_for_job($this->session->userdata('user_id'), $row->ID);		
			
      	  ?>
        <div class="col-md-12">
          <div class="intlist">
            <div class="col-md-2"><a href="<?php echo base_url('jobs/'.$row->job_slug);?>" class="thumbnail" title="<?php echo $row->job_title;?>"><img src="<?php echo $company_logo; ?>" alt="<?php echo base_url('companies/'.$row->company_slug);?>" /></a></div>
            <div class="col-md-10">
              ...
              <?php else:?>
              	<a href="<?php echo base_url('jobs/'.$row->job_slug);?>" class="applybtn">Ver más</a>
