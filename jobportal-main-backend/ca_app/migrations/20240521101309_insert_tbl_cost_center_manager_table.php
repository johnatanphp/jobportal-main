...
class Migration_Insert_tbl_cost_center_manager_table extends CI_Migration
{
    public function up()
    {
        $no_cias = array('02', '03', '16');
        $this->db->where_in('no_cia', $no_cias);
        $this->db->delete('tbl_cost_center_manager');
        $this->insertTable();
    }
