            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><a href="<?php echo base_url('admin/employers/search?industry_ID='.$row->ID);?>" target="_blank">View (<?php echo $this->Posted_job->count_records('tbl_companies','industry_ID',$row->ID);?>)</a></td>
