<div class="modal fade" id="modal-job-charges-add">
  <div class="modal-dialog">
    <form id="job-charges-form-add" role="form" method="post" action="<?php echo site_url('admin/job_charges/add'); ?>">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Agregar  Grupo Ocupacional</h4>
        </div>
