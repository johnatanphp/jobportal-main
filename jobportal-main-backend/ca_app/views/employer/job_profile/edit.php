...
<html lang="en">
  ...
  <div class="container detailinfo">
    <div class="row"> 
      <?php echo form_open('employer/job_profiles/profiles/edit/' . $mof->ID, ['id' => 'form-profile-edit']); ?>
      <div class="col-md-3">
        ...
        <div class="formwraper">
          ...
          <div class="formint">
            ...
            <h3 class="sub-title-h3">Datos del cliente</h3>
              <div class="input-group <?php echo (form_error('consultant_name'))?'has-error':'';?>">
                <label class="input-group-addon">Consultora <span>*</span></label>
                  <select id="consultant" 
                          name="consultant_name" 
                          class="form-control" 
                          data-value="<?php echo $mof->consultant_name;?>"
                          style="width: 100%;" 
                          required>
              ...
              <div class="input-group <?php echo (form_error('business_unit_name'))?'has-error':'';?>">
                <label class="input-group-addon">Unidad de negocio <span>*</span></label>
                <select id="business-unit" name="business_unit_name" class="form-control" style="width: 100%;" required>
              ...
              <div class="input-group <?php echo (form_error('client_company_name'))?'has-error':'';?>">
              ...
              <div class="input-group <?php echo (form_error('cost_center'))?'has-error':'';?>">
              ...
              <div class="input-group <?php echo (form_error('sunat_code'))?'has-error':'';?>">
                ...
                <input name="sunat_code" 
                       type="text" 
                       class="form-control" 
                       id="sunat_code" 
                       placeholder="Código SUNAT" 
                       value="<?php echo set_value('sunat_code') ? set_value('sunat_code') : $mof->sunat_code; ?>" 
                       maxlength="180">
              ...
              <div class="input-group <?php echo (form_error('occupational_group'))?'has-error':'';?>">
                ...
                <div class="input-group <?php echo (form_error('risk_criteria')) ? 'has-error':'';?>">
                  ...
                  <select name="risk_criteria" required class="form-control" id="risk_criteria">
                    <option value="">Seleccione</option>
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            $.each(clients, function(i, row) {
              ...
              $( "#client-company" ).append('<option data-cod_clie="' + row.COD_CLIE + '" value="' + clientValue + '">' + row.CLIENTE + '</option>');
            });

            $( "#client-company" ).val($( "#client-company" ).data('value'));
          }
        })
        .fail(function() {
      ...
      function getCostCenters()
      {
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            $( "#cost-center" ).val($( "#cost-center" ).data('value'));     
          }
        })
        .fail(function() {
