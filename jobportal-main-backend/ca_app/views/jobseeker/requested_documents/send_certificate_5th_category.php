...
<html lang="en">
      ...
      <div class="col-md-9">
        ...
        <div class="formwraper">
          <div class="titlehead">
            ...
            <b>Certificado de 5ta categoría</b>
          </div>        
          <div class="formint">

              <div style="text-align: right;padding: 10px 0;">
                <a href="#" class="show-rs-doc-comments" data-document="certificate_5th_category">
                  Ver comentarios recibidos
                </a>  
              </div>
              <div class="msg-info">
                Por favor carga tu certificado de 5ta categoría
                    ...
                    <div class="col-sm-12">
                      <div style="background: #efefef;border: 1px solid #ccc;padding: 12px 8px;font-size: 20px;">
                        ...
                        <div style="display: inline-block;border: 1px solid #ccc;background: #fff;padding: 8px;">
                          <a href="<?php echo file_url($file->attach_file_name, 'public/uploads/candidate/certificate_5th_category'); ?>" target="_blank">
  ...
  <script type="text/javascript">
    ...
    function showSelectorFiles() {
      ...
      var url = "<?php echo site_url('jobseeker/requested_documents/upload_certificate_5th_category/'); ?>";
