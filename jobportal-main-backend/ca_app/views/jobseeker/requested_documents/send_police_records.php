      ...
      <div class="col-md-9">
        ...
        <div class="formwraper">
          <div class="titlehead">
            ...
            <b>Antecedentes policiales</b>
          </div>        
          <div class="formint">

              <div style="text-align: right;padding: 10px 0;">
                <a href="#" class="show-rs-doc-comments" data-document="police_records">
                  Ver comentarios recibidos
                </a>  
              </div>
              <div class="msg-info">
                Por favor carga tus antecedentes policiales
                    ...
                    <div class="col-sm-12">
                      <div style="background: #efefef;border: 1px solid #ccc;padding: 12px 8px;font-size: 20px;">
                        <div style="font-style: italic; border-bottom: 1px solid #ccc; margin-bottom: 10px;color: #444;font-size: 14px;padding: 5px;">
                          ...
                          Tus antecedentes policiales han sido subidos
                        ...
                        <div style="display: inline-block;border: 1px solid #ccc;background: #fff;padding: 8px;">
                          <a href="<?php echo file_url($file->attach_file_name, 'public/uploads/candidate/police_records'); ?>" target="_blank">
  ...
  <script type="text/javascript">
    ...
    function showSelectorFiles() {
      ...
      $(fileDocument).fileupload({
        dataType: 'json',
        url: "<?php echo base_url('jobseeker/requested_documents/upload_police_records/'); ?>",
        autoUpload: true,
        add: function (e, data) {
