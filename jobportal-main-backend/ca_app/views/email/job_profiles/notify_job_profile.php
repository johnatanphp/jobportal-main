...
<ul>
    <li><b>Consultora:</b> <?php echo $job_profile->consultant_name; ?></li>
    <li><b>Cliente:</b> <?php echo $job_profile->client_company_name; ?></li>
    <li><b>Unidad de negocio:</b> <?php echo $job_profile->business_unit_name; ?></li>
    <li><b>Centro de costo:</b> <?php echo $job_profile->cost_center; ?></li>
    <li><b>Nombre:</b> <?php echo $job_profile->job_title; ?></li>
    <?php if (isset($edit_fields)): ?>
        <li><b>Campos editados:</b> <?php echo $edit_fields; ?></li>
    <?php endif; ?>
    <li><b>Creado por:</b> <?php echo $created_by; ?></li>
    <li><b>Código:</b> <?php echo $job_profile->code ? $job_profile->code : '-'; ?></li>
...
<div class="col-md-12"style="padding: 5px;">
    ...
    <tr>
        <?php if ($row_factor['automatic']): ?>
        <td width="20%" colspan="2"><?php echo $row_factor['jp_factor_name'] ? $row_factor['jp_factor_name'] : '-'; ?></td>
        <?php else: ?>
        <td width="20%">
...
<?php if (isset($structure_salary) && $structure_salary == true): ?>
    ...
    <table width="100%">
        <tr>
            ...
            <td><?php echo $job_profile->basic_minimum; ?></td>
            <td><?php echo $job_profile->basic_maximum; ?></td>
        </tr>

        <?php if (isset($jp_benefits)): ?>
            <?php foreach ($jp_benefits as $row): ?>
                <tr>
                    <td><label><?php echo $row->benefit_name; ?></label></td>
                    <td>
        ...
        <tr>
            ...
            <td><?php echo $job_profile->stereotype; ?></td>
        </tr>
        <tr>
            <td width="250"><label>Factor diferenciador</label></td>
            <td><?php echo $job_profile->factor_differentiating; ?></td>
        </tr>

        <?php if ($job_profile->factor_differentiating == 'Otro'): ?>
            <tr>
                <td width="250"><label>Factor diferenciador Otro</label></td>
                <td><?php echo $job_profile->factor_differentiating_other; ?></td>
            </tr>
        <?php endif; ?>

        <?php 
            $occupational_category = $this->Occupational_category->find($job_profile->occupational_category_id);
        ?>
        <tr>
            <td width="250"><label>Categoría ocupacional</label></td>
            <td><?php echo $occupational_category ? $occupational_category->name : '-'; ?></td>
        </tr>
        <tr>
            <td width="250"><label>Nivel Categoría ocupacional</label></td>
            <td><?php echo $occupational_category ? $occupational_category->level : '-'; ?></td>
        </tr>
    </table>
    <a href='<?php echo site_url('admin/job_profiles/show/' . $job_profile->ID); ?>'> Ver Perfil</a>
<?php else: ?>
    <a href='<?php echo site_url('employer/job_profiles/profiles/show/' . $job_profile->ID); ?>'> Ver Perfil</a>
<?php endif; ?>
