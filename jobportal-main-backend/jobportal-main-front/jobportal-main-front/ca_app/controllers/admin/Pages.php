...
class Pages extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Cms->record_count('tbl_cms');
		$config = pagination_configuration(base_url("admin/pages"), $total_rows, 25, 3, 5, true);
		...
		$obj_result = $this->Cms->get_all_records($config["per_page"], $page);
	...
	public function update($id=''){
		...
		$row = $this->Cms->get_record_by_id($id);
...
//For Page Gallery
	...
	public function remove_page_gallery_image($id=''){
		$row = $this->Pages_gallery->get_record_by_id($id);
		$this->Pages_gallery->delete($id);
