...
class Stories extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Story->record_count('tbl_stories');
		...
		$obj_result = $this->Story->get_all_records($config["per_page"], $page);
	...
	public function get_stories_by_id($id=''){
		if($id!=''){
			$row = $this->Story->get_stories_by_id($id);
	...
	public function update(){
		...
		$this->Story->update($id, $stories_array);
