...
class Migration_Insert_data_tbl_eplani_ubigeos_202411251330 extends CI_Migration
{
    public function up()
    {
        $this->insert_data();
    ...
    {   
        $this->db->where('1=1');
        $this->db->delete('tbl_eplani_ubigeos');

        $this->db->query("INSERT INTO tbl_eplani_ubigeos (code,order_administrative1,order_administrative2,order_administrative3) VALUES
            ...
            ('020702','ANCASH','Carlos Fermín Fitzcarrald','SAN NICOLAS'),
            ('020703','ANCASH','Carlos Fermín Fitzcarrald','YAUYA'),
            ...
            ('030215','APURIMAC','ANDAHUAYLAS','Santa María de Chicmo'),
            ...
            ('131102','LA LIBERTAD','VIRU','LUCMA'),
            ('131103','LA LIBERTAD','VIRU','MARMOT'),
            ('131104','LA LIBERTAD','VIRU','SAYAPULLO'),
