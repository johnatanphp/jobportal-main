  ...
  <div class="searchjoblist col-md-10"> 
    ...
    <div class="boxwraper">
      ...
      <div class="row searchlist"> 
        ...
        <div class="col-md-12">
          <div class="intlist">
            <div class="col-md-2"><a href="<?php echo base_url('jobs/'.$row->job_slug);?>" class="thumbnail"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_logo);?>" alt="<?php echo $row->company_name;?>" alt="<?php echo base_url('companies/'.$row->company_slug);?>" /></a></div>
            <div class="col-md-10">
              <div class="col-md-8"> <a href="<?php echo base_url('jobs/'.$row->job_slug);?>" class="jobtitle"><?php echo word_limiter(strip_tags($row->job_title),7);?></a>
                <div class="location"><a href="<?php echo base_url('companies/'.$row->company_slug);?>"><?php echo $row->company_name;?></a> &nbsp;-&nbsp; <?php echo $row->city;?></div>
              </div>
              <div class="col-md-4"> 
              <?php
			  	$apply_class = ($is_already_applied=='yes')?'applybtngray':'applybtn';
			  ?>
              <a href="<?php echo ($is_already_applied=='yes')?base_url('jobs/'.$row->job_slug):'javascript:;';?>" class="<?php echo $apply_class;?>">Ver</a>
