      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Jobs Posted By <span id="company_name"></span></h3><div class="paginationWrap"> <?php echo ($result)?$links:'';?> </div>
          </div>
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center"><a href="<?php echo base_url('admin/employers/details/'.$row->employer_ID);?>">
                    <img src="<?php echo img_pic_company($row->company_logo, 'thumb'); ?>" mar-height="60"/><br />
                  ...
                  <td><a href="javascript:delete_job_seeker(<?php echo camelize($row->ID);?>);" class="btn btn-danger btn-xs">Delete</a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
