...
<aside class="right-side"> 
  ...
  <section class="content-header">
    <h1>
      Gestion alertas - Perfil laboral
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('admin/home');?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="<?php echo base_url('admin/job_profiles');?>"><i class="fa fa-dashboard"></i> Perfil laboral</a></li>
        ...
        <div class="box box-primary">
          ...
          <!-- form start -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                    <?php echo form_open('admin/job_profiles/save_alert_emails'); ?>
