<div>
    <table width="100%">
        <tr>
            <td width="85%">
                <input id="mc-notification-email" type="text" class="form-control" placeholder="Ingrese email">
            </td>
            <td>
    ...
    <?php echo form_open('employer/medical_centers/notification_emails/save', ['id' => 'form-mc-save-emails']); ?>

        <input type="hidden" name="code" value="<?php echo $code; ?>">
        <table id="tbl-mc-notification-list-email" class="table" width="100%">
            <thead>
                <tr>
                    <th>Email</th>
                    <th width="50"></th>
...
<script type="text/javascript">
    ...
    $( "#form-mc-save-emails" ).submit(function(e){
    ...
    $( "#btn-add-email" ).click(function(){
        ...
        var inputEmail = $.trim($( "#mc-notification-email" ).val());
        ...
        $( "#tbl-mc-notification-list-email tbody" ).prepend(`
            <tr>
                <td>
                    <input name='emails[]' 
                           type='hidden' 
