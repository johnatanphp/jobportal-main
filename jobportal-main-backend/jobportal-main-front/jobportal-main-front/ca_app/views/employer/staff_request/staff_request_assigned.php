        ...
        <div class="col-md-9"> 
            ...
            <div class="formwraper">
                ...
                <div class="table-search">  
                    <?php echo form_open('employer/my_assigned_staff_requests/search', array('method' => 'get')); ?>    
                        <table width="100%">
                            <tr>
                                <td width="90%">
                                ...
                                <td align="right">
                                    <div class="dropdown dropdown-options-job">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('employer/my_assigned_staff_requests/export_excel?' . $_SERVER['QUERY_STRING']); ?>">
                                                    Exportar a excel
                                                </a>
                                            </li>
                                        </ul>
