...
class Seeker_permission_signs_contract extends CI_Model
{
    public function find($id_or_where)
    {
        $this->db->from('tbl_seeker_permission_signs_contracts');
    ...
    {
        $this->db->insert('tbl_seeker_permission_signs_contracts', $data);
    ...
    public function update($id_or_where, $data)
    {
        ...
        return $this->db->update('tbl_seeker_permission_signs_contracts', $data);
    }
    ...
    public function delete($id_or_where)
    {
        ...
        return $this->db->delete('tbl_seeker_permission_signs_contracts');
    }
