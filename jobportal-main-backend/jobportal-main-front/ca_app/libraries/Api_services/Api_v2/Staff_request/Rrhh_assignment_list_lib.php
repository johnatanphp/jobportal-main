...
class Rrhh_assignment_list_lib
{
    ...
    private function get_response($input_data)
    {
        ...
        $this->db->join('tbl_post_jobs jobs', 'jobs.ID=rrhh_assignments.job_ID');
        $this->db->join('tbl_staff_requests staff_requests', 'staff_requests.ID=jobs.request_ID');
        $this->db->join('tbl_employers employers', 'employers.ID=rrhh_assignments.rrhh_user_ID');
