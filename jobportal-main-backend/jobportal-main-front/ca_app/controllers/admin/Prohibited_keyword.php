...
class Prohibited_Keyword extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Prohibited_keywords->record_count('tbl_prohibited_keywords');
		$config = pagination_configuration(base_url("admin/prohibited_keyword"), $total_rows, 25, 3, 5, true);
		...
		$obj_result = $this->Prohibited_keywords->get_all_records($config["per_page"], $page);
	...
	public function get_prohibited_keyword_by_id($id=''){
		if($id!=''){
			$row = $this->Prohibited_keywords->get_record_by_id($id);
	...
	public function add(){
		...
		$this->Prohibited_keywords->add($data_array);
	...
	public function update(){
		...
		$this->Prohibited_keywords->update($id, $data_array);
		$this->write_data_into_file();
	...
	public function delete($id=''){
		...
		$obj_row = $this->Prohibited_keywords->delete($id);
		echo 'done';
		exit;
	}
	
	public function write_data_into_file(){
		$result = $this->Prohibited_keywords->get_all_records();
		$keywords = '';
