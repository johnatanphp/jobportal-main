...
class Job_Alert_Queue extends CI_Controller {
	public function index(){
		...
		$obj_result = $this->Job_alert->get_queue_list_grouped();
		$setting_row = $this->Job_alert->get_settings();
	...
	public function delete_queue($job_id=''){
		...
		$this->Job_alert->delete_by_job_id($job_id);
	...
	public function update_email_rate(){
		...
		$this->Job_alert->update_settings('1',$data_array);
