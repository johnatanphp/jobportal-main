...
class Home extends CI_Controller {
	...
	{		
		...
		$userRow = $this->Admin->authenticate_admin($this->input->post('username'), $password);
	...
	{	
		...
		$is_correct = $this->Admin->get_current_password($this->input->post('oldpass'));
		...
		$this->Admin->update($this->session->userdata('admin_id'), array('admin_password'=>do_hashing($this->input->post('newpass'))));
