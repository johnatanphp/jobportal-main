      ...
      <div style="padding-top: 15px;">
          ...
          <select name="emo_type" class="form-control js-resource-input" id="type_emo" style="width: 100%;">
            ...
            <?php foreach ($exam_emo_types as $row): ?>
              <option value="<?php echo $row->id; ?>"
                      <?php echo $request_resource->emo_type_id == $row->id ? 'selected' : ''; ?>>
                <?php echo $row->name; ?>
              </option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-emo-protocol-detail" style="display:none;">
          ...
          <input id="protocol-detail" 
                 type="text" 
                 name="emo_protocol_detail" 
                 class="form-control" 
                 placeholder="Detallar Protocolo"
                 value="<?php e($request_resource->emo_protocol_detail); ?>">
        </div>
        ...
        <div class="input-group cont-emo-expense-type">
          ...
          <select class="form-control js-resource-type-expense"
              ...
              <?php foreach ($expense_types as $row): ?>
                <option value="<?php echo $row->id; ?>"
                        <?php echo $request_resource->emo_expense_type == $row->id ? 'selected' : ''; ?>>
                  <?php echo $row->id; ?>
                </option>
              <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-emo-staff-charge">
          ...
          <input type="text" 
                 name="emo_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->emo_staff_charge); ?>">
        </div>
      </div>
    </div>
      ...
      <div style="padding-top: 15px;">
        <div class="input-group" >
          ...
          <select name="screening_type" class="form-control js-resource-input" id="type_screening" style="width: 100%;">
            ...
            <?php foreach ($screening_types as $row): ?>
              <option value="<?php echo $row->id; ?>"
                      <?php echo $request_resource->screening_type_id == $row->id ? 'selected' : ''; ?>>
                <?php echo $row->name; ?>
              </option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-screening-expense-type">
          ...
          <select class="form-control js-resource-type-expense"
              ...
              <?php foreach ($expense_types as $row): ?>
                <option value="<?php echo $row->id; ?>"
                        <?php echo $request_resource->screening_expense_type == $row->id ? 'selected' : ''; ?>>
                  <?php echo $row->id; ?>
                </option>
              <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-screening-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->screening_perform_stage; ?>
        ...
        <div class="input-group cont-screening-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="screening_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->screening_staff_charge); ?>">
        </div>
      </div>
    </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select name="covid19_type" 
            ...
            <?php foreach ($exam_covid19_types as $row): ?>
              <option value="<?php echo $row->id; ?>"
                      <?php echo $request_resource->covid19_type_id == $row->id ? 'selected' : ''; ?>>
                <?php echo $row->name; ?>
              </option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-covid19-expense-type">
          ...
          <select class="form-control js-resource-type-expense"
              ...
              <?php foreach ($expense_types as $row): ?>
                <option value="<?php echo $row->id; ?>"
                        <?php echo $request_resource->covid19_expense_type == $row->id ? 'selected' : ''; ?>>
                  <?php echo $row->id; ?>
                </option>
              <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-covid19-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->covid19_perform_stage; ?>
        ...
        <div class="input-group cont-covid19-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="covid19_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->covid19_staff_charge); ?>">
        </div>
      </div>
    </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select id="exams-complementary" 
                  ...
                  style="width: 100%;">
            <?php 
              $type_exam_complementary_selected = $request_resource->exam_complementary;
            ?>
            <?php foreach (options_exams_complementary() as $option): ?>
              <option value="<?php echo $option; ?>" 
                      <?php echo $option == $type_exam_complementary_selected ? 'selected="selected"' : '';?>>
                <?php echo $option; ?>
              </option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="input-group cont-exams-complementary-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="exam_complementary_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->exam_complementary_staff_charge); ?>">
        </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select name="verify_home" 
            ...
            <option value="0" <?php echo $request_resource->verify_home == '0' ? 'selected="selected"' : ''?>>
              NO
            </option>
            <option value="1" <?php echo $request_resource->verify_home == '1' ? 'selected="selected"' : ''?>>
              SÍ
            </option>
          </select>
        </div>
        ...
        <div class="input-group cont-home-verification-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->verify_home_perform_stage; ?>
        ...
        <div class="input-group cont-home-verification-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="verify_home_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->verify_home_staff_charge); ?>">
        </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group ">
          ...
          <select name="verify_credit" 
            ...
            <option value="0" <?php echo $request_resource->verify_credit == '0' ? 'selected="selected"' : ''?>>
              NO
            </option>
            <option value="1" <?php echo $request_resource->verify_credit == '1' ? 'selected="selected"' : ''?>>
              SÍ
            </option>
          </select>
        </div>
        ...
        <div class="input-group cont-credit-verification-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->verify_credit_perform_stage; ?>
        ...
        <div class="input-group cont-credit-verification-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="verify_credit_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->verify_credit_staff_charge); ?>">
        </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select name="verify_labor" 
            ...
            <option value="0" <?php echo $request_resource->verify_labor == '0' ? 'selected="selected"' : ''?>>
              NO
            </option>
            <option value="1" <?php echo $request_resource->verify_labor == '1' ? 'selected="selected"' : ''?>>
              SÍ
            </option>
          </select>
        </div>
        ...
        <div class="input-group cont-labor-verification-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->verify_labor_perform_stage; ?>
        ...
        <div class="input-group cont-labor-verification-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="verify_labor_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->verify_labor_staff_charge); ?>">
        </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select name="verify_degree" 
            ...
            <option value="0" <?php echo $request_resource->verify_degree == '0' ? 'selected="selected"' : ''?>>
              NO
            </option>
            <option value="1" <?php echo $request_resource->verify_degree == '1' ? 'selected="selected"' : ''?>>
              SÍ
            </option>
          </select>
        </div>
        ...
        <div class="input-group cont-degrees-titles-verification-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->verify_degree_perform_stage; ?>
        ...
        <div class="input-group cont-degrees-titles-verification-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="verify_degree_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->verify_degree_staff_charge); ?>">
        </div>
      ...
      <div style="padding-top: 15px;">
        ...
        <div class="input-group">
          ...
          <select name="verify_degree_person" 
            ...
            <option value="0" <?php echo $request_resource->verify_degree_person == '0' ? 'selected="selected"' : ''?>>
              NO
            </option>
            <option value="1" <?php echo $request_resource->verify_degree_person == '1' ? 'selected="selected"' : ''?>>
              SÍ
            </option>
          </select>
        </div>
        ...
        <div class="input-group cont-degrees-titles-person-verification-perform-stage">
          ...
          <select class="form-control js-resource-stage"
            ...
            <?php $perform_on_stage = $request_resource->verify_degree_person_perform_stage; ?>
        ...
        <div class="input-group cont-degrees-titles-person-verification-staff-charge">
          <label class="input-group-addon">Encargado <span></span></label> 
          <input type="text" 
                 name="verify_degree_person_staff_charge" 
                 class="form-control" 
                 value="<?php e($request_resource->verify_degree_person_staff_charge); ?>">
        </div>
