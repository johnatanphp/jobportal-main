  ...
  <div class="row">
    ...
    <!--Job Detail-->
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-12"><b>Mis postulaciones</b></div>
          </div>
        </div>
        ...
        <div class="companydescription">
		  ...
		  ?>
                <li class="row" id="aplied_<?php echo $row_applied_job->applied_id;?>">
                  ...
                  <div class="col-md-4"><a href="<?php echo base_url('companies/'.$row_applied_job->company_slug);?>"><?php echo $row_applied_job->company_name;?></a></div>
