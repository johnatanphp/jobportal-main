  ...
  <section class="content invoice"> 
    ...
    <div class="row invoice-info">
      ...
      <div class="col-sm-3 invoice-col"><b>Contact Number:</b> <?php echo $row->mobile;?><br/>
          <b>Gender:</b> <?php echo gender_text($row->gender);?><br>
          <b>Date of Birth:</b> <?php echo $row->dob;?> <br/>
          <b>City:</b> <?php echo $row->city;?><br>
          <b>Country:</b> <?php echo country_text($row->country);?>
      </div>
      <!-- /.col -->
      <div class="col-sm-2 invoice-col" style="text-align:right"> 
      	<img style="border-radius:50%;" src="<?php echo img_pic_candidate($row->photo); ?>" height="100">
      <!-- /.col --> 
    </div>
    <!-- /.row -->
    </div>
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center"><a href="<?php echo base_url('admin/employers/details/'.$row->employer_ID);?>">
                    <img src="<?php echo img_pic_company($row->company_logo); ?>" height="60"/><br />
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href="<?php echo base_url('admin/job_seekers/update/'.$row->ID);?>"><button class="btn btn-default"><i class="fa fa-edit"></i> Edit This Record</button> </a><!--&nbsp;&nbsp;
