...
{   
    ...
    private function build($entry_form_id)
    {
        ...
        $entry_form_mx = $this->Entry_form_mx->get_by_entry_form_id($entry_form_id);
        $rightful_claimants = $this->Entry_form_mx->get_rightful_claimants($entry_form_id);
        ...
        $html = $this->load->view('jobseeker/entry_form/mx/common/entry_form_view', $data, true);

        $this->title = "Overall - Ficha Ingreso - " . $entry_form_mx->identity_document_number . " - ". $entry_form_mx->first_name;
