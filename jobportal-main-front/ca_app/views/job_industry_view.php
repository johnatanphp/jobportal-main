  ...
  <div class="searchjoblist col-md-10"> 
    ...
    <div class="boxwraper">
      ...
      <div class="row searchlist"> 
        ...
        <div class="col-md-12">
          <div class="intlist">
            <div class="col-md-2"><a href="<?php echo base_url('jobs/'.$row->job_slug);?>" class="thumbnail" title="<?php echo $row->job_title;?>"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_logo);?>" alt="<?php echo base_url('companies/'.$row->company_slug);?>" /></a></div>
            <div class="col-md-10">
