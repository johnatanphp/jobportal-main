            ...
            <div class="intlist">
              ...
              <div class="col-md-10">
                <div class="col-md-7"> <a href="<?php echo $row['url'];?>" target="_blank" class="jobtitle" title="<?php echo $row['jobtitle'];?>"><?php echo $row['jobtitle'];?></a>
                  <div class="location"><a href="<?php //echo base_url('companies/'.$row->company_slug);?>#" title="Jobs in <?php echo $row['company'];?>"><?php echo $row['company'];?></a> &nbsp;-&nbsp; <?php echo $row['formattedLocationFull'];?></div>
                </div>
                <div class="col-md-5"> <a href="<?php echo $row['url'];?>" target="_blank" class="applybtn">Ver</a>
                  <div class="date"><?php echo ucwords(_date_locale_format(strtotime($row['date']), 'MMM dd, y'));?></div>
                </div>
                <div class="clear"> </div>
