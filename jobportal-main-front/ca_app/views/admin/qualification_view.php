...
<div class="modal fade" id="add_page_form">
  <div class="modal-dialog">
    <form name="frm_qualification" id="frm_qualification" role="form" method="post" action="<?php echo base_url('admin/qualifications/add');?>">
...
<div class="modal fade" id="edit_page_form">
  <div class="modal-dialog">
    <form name="frm_qualification" id="frm_qualification" role="form" method="post" action="<?php echo base_url('admin/qualifications/update');?>" onSubmit="return validate_edit_qualification_form(this)">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Qualification</h4>
