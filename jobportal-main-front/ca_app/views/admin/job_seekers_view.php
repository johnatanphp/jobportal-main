          ...
          <div class="box-body table-responsive">
            <form name="search_form" id="search_form" method="post" action="<?php echo base_url('admin/job_seekers/search');?>">
              <div class="row" style="background-color:#3C8DBC; padding:10px; margin:0;">
                <div class="col-md-2 margin-bottom-special" style="display: none;">
                ...
                <div class="col-md-6">
                  <input class="form-control" style="min-width:100%;" name="search_email" id="search_email" type="text" placeholder="Search By Email" value="<?php echo (isset($search_data["email"]))?$search_data["email"]:'';?>">
                </div>
                <div class="col-md-3 margin-bottom-special" style="display: none;">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center"><a href="<?php echo base_url('admin/job_seekers/details/'.$row->ID);?>">
                    <img src="<?php echo img_pic_candidate($row->photo); ?>" style="border-radius:50%" height="60" /><br/>
                    <?php echo $row->first_name.' '.$row->last_name;?></a></td>
                  <td><?php echo $row->email;?></td>
                  <td><?php echo $row->present_address;?></td>
                  <td><?php echo $row->city;?></td>
                  <td><a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/job_seekers/applied_jobs_list/'.$row->ID);?>" target="_blank">View (<?php echo $this->Applied_jobs->count_records('tbl_seeker_applied_for_job','seeker_ID',$row->ID);?>)</a></td>
                  <!--
                  <td>
                  ...
                  <td>
                    <?php if ($this->session->userdata('admin_id') == 1): ?>
                      <a href="<?php echo base_url('admin/job_seekers/update/'.$row->ID);?>" class="btn btn-primary btn-xs">Edit Candidate</a>
                      <br />
                    <?php endif; ?>
                    <a target="_blank" href="<?php echo base_url('admin/job_seekers/login/'.$row->ID);?>" class="btn btn-primary btn-xs" style="margin:1px;">Login as Candidate</a>
                </tr>
                <?php endforeach; else:?>
                <tr>
