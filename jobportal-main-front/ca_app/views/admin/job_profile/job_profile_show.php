...
<aside class="right-side"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo site_url('admin/job_profiles');?>">Pefil de puesto</a></li>
        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <span class="pull-right" style="padding-right: 10px;font-size:15px;">
                    ...
                    <a style="margin-top:8px;" class="link-edit" href="<?php echo site_url('admin/job_profiles/edit/') . $mof->ID; ?>">
            ...
            <div class="formint">
              ...
              <div class="row">
                <div class="col-xs-4"><label>Consultora</label></div>
                <div class="col-xs-7"><?php echo $mof->consultant_name; ?></div>
              </div>
              <div class="row">
                <div class="col-xs-4"><label>Unidad de negocio</label></div>
                <div class="col-xs-7"><?php echo $mof->business_unit_name; ?></div>
              </div>
              <div class="row">
                <div class="col-xs-4"><label>Empresa cliente</label></div>
                <div class="col-xs-7"><?php echo $mof->client_company_name; ?></div>
              </div>
              <div class="row">
                <div class="col-xs-4"><label>Centro de costo</label></div>
                <div class="col-xs-7"><?php echo $mof->cost_center; ?></div>
              </div>
              <h3 class="sub-title-h3">Descripción del puesto</h3>
              <div class="row">
                <div class="col-xs-4"><label>ID perfil</label></div>
                <div class="col-xs-7"><?php echo $mof->ID; ?></div>
              </div>
              
              <div class="row">
                  <div class="col-xs-4"><label>Código del perfil</label></div>
              ...
              <div class="row"> 
                ...
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <table id="table-resources" class="tbl-base-1 tbl-style-1" width="100%">
                          <tbody>
                              <tr>
                                <?php 
                                ...
                                <td></td>
                                 <td>
                                  <?php 
                                    ...
                                    $covid19_values = explode(',', @$resource_covid->resource_value);
                                  
                                    foreach ($covid19_values as $val) {
                                      $val = trim($val);
                                      echo isset($covid_array[$val]) ? $covid_array[$val] . '<br />' : '';
                                    }
                                  ?>
                                  <div style="margin-top: 5px;">
                                      Tipo Egreso:
                                      <?php echo @$resource_covid->type_expense ? $resource_covid->type_expense : '-'; ?>
                                  </div>
                                </td>
                                <td>
                                  <?php echo @$resource_covid->perform_on_stage ? $rys_stages[$resource_covid->perform_on_stage] : '-'; ?>
                                </td>
                                <td>
                                  <?php echo @$resource_covid->staff_in_charge ? $resource_covid->staff_in_charge : '-'; ?>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <th width="5%"></th>
                                <th width="40%">
                                  Verificación de grados y titulos
                                </th>
                                <th>Realizar a</th>
                                <th width="40%">
                                  Encargado
                              ...
                              <tr>
                                ...
                                <th width="5%"></th>
                                <th width="40%">
                                  Verificación de grados y titulos presenciales
                                </th>
                                <th>
                                  Realizar a
                                </th>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div><h4 style="font-size: 16px;">Puntaje total: <?php echo $jp_factor_total_score; ?></h4></div>
                </div>
              </div>
              <br />
...
<div id="modal-export" class="modal" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <?php echo form_open('admin/job_profiles/export', ['method' => 'get', 'target' => '_blank']); ?>
      <input type="hidden" name="id"  value="<?php echo $mof->ID; ?>">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Exportar Detalle Perfil laboral</h4>
        </div>
