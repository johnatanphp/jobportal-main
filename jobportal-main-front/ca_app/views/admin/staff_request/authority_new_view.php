    ...
    <div class="row">
      ...
      <div class="col-md-8"> 
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header --> 
          <!-- form start -->
          <?php echo form_open('admin/staff_request_authorities/create/' . $company_id . '/' . $authority_type); ?>
            <div class="box-body">
              ...
              <div class="formint">
                ...
                <div class="form-group <?php echo (form_error('authority_name'))?'has-error':'';?>">
                  ...
                  <input name="authority_name" type="authority_name" class="form-control" placeholder="Nombre y apellido" value="">
                  <?php echo form_error('authority_name'); ?>
                </div>
                
                <div class="form-group <?php echo (form_error('authority_email'))?'has-error':'';?>">
                  <label >Email <span>*</span></label>
                  <input name="authority_email" type="text" class="form-control" placeholder="Email" value="">
                  ...
                  <div class="form-group <?php echo (form_error('authority_business_unit')) ? 'has-error':'';?>">
                      ...
                      <select id="authority-business-unit" name="authority_business_unit" class="form-control">
                        ...
                        <?php foreach ($business_units as $row): ?>
                          <option value="<?php echo $row->ID; ?>"><?php echo $row->business_unit_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    <?php echo form_error('authority_email'); ?>
                  </div>
