  ...
  <aside class="right-side"> 
    ...
    <section class="content">
     <table width="100%" border="0" align="left">
              ...
              <tr>
                <td width="19%" align="center"><a href="<?php echo base_url('admin/companies');?>"><i class="fa awesome_style fa-briefcase"></i><br>
                Companies</a></td>
...
Ads</a></td>
              ...
              <tr>
                <td align="center"><a href="<?php echo base_url('admin/industries');?>"><i class="fa fa-desktop awesome_style"></i><br>
                  Job Industries</a></td>
                <td align="center"><a href="<?php echo base_url('admin/institutes');?>"><i class="fa awesome_style fa-university"></i><br>
                  Institute</a></td>
                <td align="center"><a href="<?php echo base_url('admin/salary');?>"><i class="fa awesome_style fa-money"></i> <br>
                  Salary</a></td>
                <td align="center"><a href="<?php echo base_url('admin/qualifications');?>"><i class="fa  awesome_style fa-graduation-cap">&nbsp;</i><br>
               Qualification</a></td>
...
Manage Skills</a></td>
                ...
                <td align="center">
                  <a href="<?php echo base_url('admin/job_alert_queue');?>"><i class="fa fa-envelope awesome_style"></i><br>
                  Job Alert Queue</a>
                </td>
                <td align="center">
                  <a href="<?php echo base_url('admin/config');?>"><i class="fa fa-cog awesome_style"></i><br>
                  Configuración
                  </a>
                </td>
                <td align="center"></td>
