<div class="modal fade" id="modal-contract-documents-add">
  <div class="modal-dialog">
    <?php echo form_open('employer/recruitment/contract_documents/add', ['id' => 'form-contract-documents-add', 'method' => 'post']); ?>
