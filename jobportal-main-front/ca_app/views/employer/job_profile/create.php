...
<head>
  ...
  <div class="container detailinfo">
    <div class="row"> 
      <?php echo form_open_multipart('employer/job_profiles/profiles/create', ['id' => 'form-profile-create']); ?>    
      <div class="col-md-3">
        ...
        <div class="formwraper">
          ...
          <div class="formint">
            ...
            <div class="input-group <?php echo (form_error('consultant_name'))?'has-error':'';?>">
              ...
              <select id="consultant" name="consultant_name" class="form-control" style="width: 100%;" required>
            ...
            <div class="input-group <?php echo (form_error('business_unit_name'))?'has-error':'';?>">
              ...
              <select id="business_unit" name="business_unit_name" class="form-control" style="width: 100%;" required>
                <option value="">Seleccione</option>
            ...
            <div class="input-group <?php echo (form_error('client_company_name'))?'has-error':'';?>">
              ...
              <select id="client_company" name="client_company_name" class="form-control" style="width: 100%;" required>
                <option value="">Seleccione</option>
              </select>
            ...
            <div class="input-group <?php echo (form_error('cost_center'))?'has-error':'';?>">
              ...
              <select id="cost_center" name="cost_center" class="form-control" style="width: 100%;" required>
                <option value="">Seleccione</option>
              </select>
      ...
      function getClientsCompany() {
        ...
        $.post(url, data, function(data) {
          ...
          $.each(clients, function(i, row) {
            ...
            $( "#client_company" ).append('<option data-cod_clie="' + row.COD_CLIE + '" value="' + clientValue + '">' + row.CLIENTE + '</option>');
          });      
        }, 'json')
        .fail(function() {
