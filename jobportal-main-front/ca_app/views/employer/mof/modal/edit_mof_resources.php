<!-- Modal -->
<div id="modal-edit-mof-resources" class="modal fade" role="dialog">
    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('employer/mofs/mofs/edit_resources', ['id' => 'form-mof-edit-resources']); ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                    <button id="edit-mof-resources" type="submit" class="btn btn-primary">
                                        Guardar
                                    </button>
                                </td>
                            </tr>
