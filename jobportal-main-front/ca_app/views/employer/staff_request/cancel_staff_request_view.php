	...
	<div class="dashiconwrp">
		...
		<div class="col-md-9"> 
			...
			<div class="formwraper">
				...
				<div class="formint">	
					<?php echo form_open_multipart('', array('id' => 'form-cancel-request')); ?>
					<div style="margin-top:15px;">
						<div class="msj-info">
							Por favor ingrese un motivo para poder cancelar la solicitud.							
						</div>	
						...
						<div class="input-group <?php echo (form_error('reason'))?'has-error':'';?>">
							<label>Motivo de la cancelación<span style="color: red;">*</span></label>
					...
					<div style="text-align: center;">
						<input type="submit" value="Cancelar solicitud" class="btn btn-primary">
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$( "#form-cancel-request" ).submit(function(e) {
			e.preventDefault();
			var confirm = window.confirm("¿Está seguro de cancelar la solicitud?");
			if (confirm) {
				this.submit();
			}
		});
