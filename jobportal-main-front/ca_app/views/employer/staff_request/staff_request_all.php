        ...
        <div class="col-md-9"> 
            ...
            <div class="formwraper">
                <div class="titlehead">
                    <div class="row">
                        <div class="col-md-12">
                            <b>Todas las solicitudes recibidas</b>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-search">
                    <?php echo form_open('employer/all_staff_requests/search', array('method' => 'get')); ?>    
                        <table width="100%">
                            <tr>
                                <td width="90%">
                                ...
                                <td align="right">
                                    <div class="dropdown dropdown-options-job">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal-export-request">
                                                    Exportar a excel
                                                </a>
                                            </li>
                                        </ul>
                ...
                <div class="table-responsive">
                    <table width="100%" class="table table-striped">
                        <thead>
                            <tr>
                                <th style="text-align: left;" width="260">
                                    Solicitud
                                </th>
                                <th style="text-align: left;" width="160">
                                    Solicitante
                                </th>
                                <th style="text-align: left;">Asignada</th>
                                <th style="text-align: left;" width="85">Tipo</th>
                                ...
                                <tr>
                                    <td style="text-align: left;">
                                        ...
                                        <span class="text-info">
                                            Código: <?php echo $row_request->ID; ?>
                                        </span>
                                        <span class="text-info">
                                            Creada: <?php echo _date_locale_format(strtotime($row_request->creation_date), 'dd MMM y'); ?>
                                        </span>
                                    </td>
                                    <td style="text-align: left;">
                                    ...
                                    <td style="text-align: left;">
                                        <?php if ($row_request->request_assigned_employer_id): ?>
                                            <a 
                                                href="#" 
                                    ...
                                    <td style="text-transform: uppercase;text-align: left;">
                                        <?php if ($row_request->sts_process == 'published'): ?>
                                            <a href="<?php echo site_url('employer/recruitment_processes/' . $row_request->job_ID); ?>" target="_blank">
                                                <?php 
...
<!-- Modal -->
<div id="modal-filter-request" class="modal" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Filtrar Solicitudes de personal</h4>
      </div>
      <div class="modal-body">
        <div class="panel-filter"> 
          <div class="filter-title">
            ...
            <select name="request_year" class="form-control">
                <option value="all">Todos</option>
                <?php for($year = 2018; $year <= date('Y'); $year++): ?>
                    <?php $year_select = $filters['request_year'] > 0 ?  $filters['request_year'] :  date('Y'); ?>
                    <option value="<?php echo $year; ?>" <?php echo $year_select == $year ? 'selected="selected"' : ''; ?>>
                        <?php echo $year; ?>
                    </option>
                <?php endfor; ?>
...
<!-- Modal -->
<div id="modal-export-request" class="modal" role="dialog">
  <div class="modal-dialog">
    <?php echo form_open('employer/all_staff_requests/export_excel', array('method' => 'get')); ?>
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Exportar Solicitudes de personal</h4>
      </div>
      <div class="modal-body">
        <div class="panel-filter"> 
          <div class="filter-title">
            ...
            <select name="request_year" class="form-control">
                <?php for($year = 2018; $year <= date('Y'); $year++): ?>
                    <?php $year_select = $filters['request_year'] != 'all' ?  $filters['request_year'] :  date('Y'); ?>
                    <option value="<?php echo $year; ?>" <?php echo $year_select == $year ? 'selected="selected"' : ''; ?>>
                        <?php echo $year; ?>
                    </option>
                <?php endfor; ?>
