          ...
          <div class="titlehead">
            <div class="row">
              <div class="col-md-12">
                ...
                <b>Reporte atención de requerimientos</b>
              </div>
            </div>
          </div>   
          <div class="formint">
            <div>
              <div style="padding: 12px 0;">
                <?php echo form_open('employer/operational_reports/staff_requests/attention_requirements_summary/export', ['method' => 'get']); ?>
                  <div class="input-group">
                    <label class="input-group-addon">Año <span>*</span></label>
                    <select class="form-control" name="year" required style="width: 100%;">
                  ...
                  <div class="input-group">
                    <label class="input-group-addon">Modelo solicitud <span>*</span></label>
                    <select class="form-control" name="request_model_id" required style="width: 100%;">
                      <option value="">Seleccione</option>
                      <option value="1">Interna</option>
                      <option value="2">Externa</option>
                      <option value="3">Externa MK</option>
                    </select>
                  </div>
