...
<div class="container detailinfo">
  <div class="row"> 
    <?php echo form_open_multipart('jobseeker/entry_form/mx/form_mx/save',array('id' => 'entry_form', 'onSubmit' => ''));?>
  ...
  <?php $this->load->view('jobseeker/entry_form/mx/common/modal_add_rightful_claimant'); ?>
</div>
