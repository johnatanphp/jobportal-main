...
<div class="vBasicBox">
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div class="txtfont"><?php echo $row->city.', '.country_text($row->country);?></div>
  ...
  <ul class="edurowlist">
   <?php 
			if($result_experience):
				...
				$date_to = ($row_experience->end_date) ? ucwords(_date_locale_format(strtotime($row_experience->end_date), 'MMM y')): 'Present';
		?>
    <li id="exp_<?php echo $row_experience->ID;?>">
      ...
      <div class="txtfont">Duration: <?php echo ucwords(_date_locale_format(strtotime($row_experience->start_date), 'MMM y'));?> to <?php echo $date_to;?></div>
    </li>
    <?php endforeach; endif;?>
