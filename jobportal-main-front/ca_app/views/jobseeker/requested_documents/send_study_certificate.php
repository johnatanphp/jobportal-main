...
<html lang="en">
      ...
      <div class="col-md-9">
        ...
        <div class="formwraper">
          <div class="titlehead">
            ...
            <b>Agregar Certificados de estudios</b>
          </div>        
          <div class="formint">
            <div style="text-align: right;padding: 10px 0;">
              <a href="#" class="show-rs-doc-comments" data-document="study_certificates">
                  ...
                  <div class="col-md-4">
                    <div class="wrapper-document-load" data-study-id="<?php echo $study->ID; ?>">
                      ...
                      <div class="document-load" style="<?php echo $study->attached_certificate ? 'display: none': 'display: block'; ?>"">
                        <button class="btn btn-primary btn-xs load-file">Agregar certificado</button>
                      </div>
  ...
  <script type="text/javascript">
    ...
    function showSelectorFiles(elementTarget) {
      ...
      var url = "<?php echo base_url('jobseeker/requested_documents/upload_study_certificates/'); ?>";
