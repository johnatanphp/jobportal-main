<div class="modal-dialog">  
    <form name="frm_edit_education" id="frm_edit_education" role="form" method="post" action="<?php echo site_url('jobseeker/education/edit');?>">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div id="emsg_profle"></div>
            ...
            <div class="form-group">
              <label>Título</label>
              <input type="text" class="form-control"  id="ed_major_subject" name="ed_major_subject" value="<?php echo $seeker_academic->major; ?>" placeholder="Tema principal">
            </div>
                ...
                <div class="row">                  
                  <div class="col-md-12">
                    <select class="form-control" name="institution" required>
                      ...
                      <?php foreach ($result_institutions as $row): ?>
                ...
                <div class="row">                  
                  <div class="col-md-12">
                    <select class="form-control" name="career" required>
                      <option value="">Seleccione</option>
                      <?php foreach ($result_careers as $row): ?>
            ...
            <div class="form-group">
              <label>Fecha inicio</label>
                  <?php $star_date = $seeker_academic->start_date; ?>
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <select class="form-control" name="month_start_date" id="ed_start_month" required>
                      ...
                      <option value="<?php echo $month;?>" <?php echo substr($seeker_academic->start_date, 5, 2) == $month ? 'selected' : ''; ?>>
                        <?php echo ucwords(_date_locale_format(strtotime($dummy_date), 'MMMM'));?>
                      </option>
                      <?php endfor; ?>
                    </select>  
                  </div>
