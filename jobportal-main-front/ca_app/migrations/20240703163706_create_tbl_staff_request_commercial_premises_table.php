...
class Migration_Create_tbl_staff_request_commercial_premises_table extends CI_Migration
{
    public function up()
    {
        ...
        $this->dbforge->create_table('tbl_staff_request_commercial_premises');
    }

    public function down()
    {
        $this->dbforge->drop_table('tbl_staff_request_commercial_premises');
    }
}
