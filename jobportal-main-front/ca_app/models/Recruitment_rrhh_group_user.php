...
class Recruitment_rrhh_group_user extends CI_Model
{
    public function find($id_or_where)
    {
        $this->db->from('tbl_recruitment_rrhh_group_users');
    ...
    {
        $this->db->insert('tbl_recruitment_rrhh_group_users', $data);
    ...
    public function update($id_or_where, $data)
    {
        ...
        return $this->db->update('tbl_recruitment_rrhh_group_users', $data);
    }
    ...
    public function delete($id_or_where)
    {
        ...
        return $this->db->delete('tbl_recruitment_rrhh_group_users');
    }
