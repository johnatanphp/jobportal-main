...
class Cities extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->City->record_count('tbl_cities');
		$config = pagination_configuration(base_url("admin/cities"), $total_rows, 25, 3, 5, true);
		...
		$obj_result = $this->City->search_cities($config["per_page"], $page);
	...
	public function get_city_by_id($id=''){
		if($id!=''){
			$row = $this->City->get_city_by_id($id);
	...
	public function add(){
		...
		$this->City->add_city($cities_array);
	...
	public function update(){
		...
		$this->City->update_cities($id, $cities_array);
	...
	public function status($id='', $current_staus=''){
		...
		$this->City->update_cities($id, $data);
	...
	public function delete($id=''){
		...
		$obj_row = $this->City->delete_cities($id);
		echo 'done';
		exit;
	}
}