...
class Email_Template extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Email->record_count('tbl_email_content');
		...
		$obj_result = $this->Email->get_all_records($config["per_page"], $page);
	...
	public function get_email_template_by_id($id=''){
		if($id!=''){
			$row = $this->Email->get_record_by_id($id);
	...
	public function update(){
		...
		$this->Email->update($id, $data_array);
