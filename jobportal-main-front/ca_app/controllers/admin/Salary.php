...
class Salary extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Salaries->record_count('tbl_salaries');
		...
		$obj_result = $this->Salaries->get_all_records($config["per_page"], $page);
	...
	public function get_salary_by_id($id=''){
		if($id!=''){
			$row = $this->Salaries->get_record_by_id($id);
	...
	public function add(){
		...
		$this->Salaries->add($salary_array);
	...
	public function update(){
		...
		$this->Salaries->update($id, $salary_array);
	...
	public function delete($id=''){
		...
		$obj_row = $this->Salaries->delete($id);
		echo 'done';
		exit;
	}
}