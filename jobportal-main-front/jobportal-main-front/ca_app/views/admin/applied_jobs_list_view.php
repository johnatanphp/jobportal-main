      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <span id="seeker_name">
              <img src="<?php echo img_pic_candidate($seeker->photo); ?>" style="border-radius:50%" height="60" /> <?php echo $seeker->first_name;?>
              </span> - Job Applications</h3><div class="paginationWrap"> <?php echo ($result)?$links:'';?> </div>
          </div>
