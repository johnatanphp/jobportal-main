...
<div class="modal fade" id="add_page_form">
  <div class="modal-dialog">
    <form name="frm_institute" id="frm_institute" role="form" method="post" action="<?php echo base_url('admin/institutes/add');?>">
...
<div class="modal fade" id="edit_page_form">
  <div class="modal-dialog">
    <form name="frm_institute" id="frm_institute" role="form" method="post" action="<?php echo base_url('admin/institutes/update');?>" onSubmit="return validate_edit_institute_form(this)">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Add New Institute</h4>
