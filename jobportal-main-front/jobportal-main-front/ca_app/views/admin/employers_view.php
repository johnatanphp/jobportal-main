            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center" valign="middle"><a href="<?php echo base_url('admin/employers/details/'.$row->ID);?>" target="_blank">
                    <?php 
                      $company_logo = img_pic_company($row->company_logo, 'thumb');
                    ?>
                    <img src="<?php echo $company_logo; ?>" mar-height="60"/><br />
				  ...
				  ?>
                    ...
                    <a onClick="update_status(<?php echo $row->user_id; ?>);" href="javascript:;" id="sts_<?php echo $row->user_id;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->sts);?></span> </a></td>
                  <td valign="middle"><a href="javascript:;" class="btn btn-primary btn-xs" onClick="load_quick_profile_view('<?php echo $json_string;?>', '<?php echo $total_posted_jobs;?>');">Profile View</a> <a href="javascript:;" onClick="load_quick_job_view('<?php echo $row->ID;?>', '<?php echo $row->company_name;?>');" class="btn btn-primary btn-xs">Job View</a>
                  
                  </td>
                  <td valign="middle"><a href="<?php echo base_url('admin/employers/update/'.$row->ID);?>" class="btn btn-primary btn-xs">Edit Employer</a><br /><a target="_blank" href="<?php echo base_url('admin/employers/login/'.$row->user_id);?>" class="btn btn-primary btn-xs" style="margin:1px;">Login as Employer</a><br /><a style="display: none;" href="javascript:delete_employer(<?php echo camelize($row->ID);?>);" class="btn btn-danger btn-xs">Delete Employer</a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
