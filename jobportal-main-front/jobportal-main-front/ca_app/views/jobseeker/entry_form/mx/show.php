        ...
        <div class="formint">
          <div class="row">
            <div class="col-md-12" style="text-align:right;">
              <a href="<?php echo site_url('jobseeker/entry_form/mx/form_mx/index/' . $contract_document_type->id . '/' . $process_id . ''); ?>" 
          ...
          <div class="row">
            <div class="col-md-12">
              <?php $this->load->view('jobseeker/entry_form/mx/common/entry_form_view'); ?>
            </div>
          </div>
