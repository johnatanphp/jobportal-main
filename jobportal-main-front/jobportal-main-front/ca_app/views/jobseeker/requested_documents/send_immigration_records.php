...
<html lang="en">
      ...
      <div class="col-md-9">
        ...
        <div class="formwraper">
          <div class="titlehead">
            ...
            <b>Record migratorio vigente (Solo para extranjeros)</b>
          </div>        
          <div class="formint">

              <div style="text-align: right;padding: 10px 0;">
                <a href="#" class="show-rs-doc-comments" data-document="immigration_records">
                  Ver comentarios recibidos
                </a>  
              </div>
              <div class="msg-info">
                Por favor carga el record migratorio vigente
                    ...
                    <div class="col-sm-12">
                      <div style="background: #efefef;border: 1px solid #ccc;padding: 12px 8px;font-size: 20px;">
                        ...
                        <div style="display: inline-block;border: 1px solid #ccc;background: #fff;padding: 8px;">
                          <a href="<?php echo file_url($file->file_path, 'public/uploads/candidate/immigration_records'); ?>" target="_blank">
  ...
  <script type="text/javascript">
    ...
    function showSelectorFiles() {
      ...
      var url = "<?php echo site_url('jobseeker/requested_documents/upload_immigration_records'); ?>";
