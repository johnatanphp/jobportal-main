      ...
      <div class="col-md-9">
        ...
        <div class="formwraper">
          <div class="titlehead">
            ...
            <b>Enviar recibo de algún servicio</b>
          </div>        
          <div class="formint">
              <div style="text-align: right;padding: 10px 0;">
                <a href="#" class="show-rs-doc-comments" data-document="receipt_service">
                  Ver comentarios recibidos
                </a>  
              </div>
              <div class="msg-info">
                Por favor carga una foto del algún recibo de agua, luz o teléfono.
                ...
                <div id="preview-file" class="row" style="<?php echo !$file ? 'display: none;' : ''; ?>">
                    <div class="col-sm-4 col-md-offset-4">
                      <a class="document-uploaded" 
                         href="<?php echo $file ? file_url($file->file_name, 'public/uploads/candidate/receipt_service') : '';?>"
                         target="_blank">
  ...
  <script type="text/javascript">
    ...
    function showSelectorFiles() {
      ...
      $(fileDocument).fileupload({
        dataType: 'json',
        url: "<?php echo site_url('jobseeker/requested_documents/upload_receipt_service/'); ?>",
        autoUpload: true,
        add: function (e, data) {
