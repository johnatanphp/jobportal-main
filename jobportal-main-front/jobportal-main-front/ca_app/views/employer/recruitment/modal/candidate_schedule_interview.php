  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <form id="form-schedule-inerview" method="POST">
            ...
            <div class="formwraper">
              ...
              <div class="formint">
                ...
                <div class="input-group">
                  ...
                  <textarea name="additional_comment" class="form-control"><?php echo @$candidate_interview->additional_comment; ?></textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <button id="btn-save-evaluations" type="button" class="btn btn-primary pull-right">
...
<script type="text/javascript">
  ...
  function sendNotificationInterview() {
    ...
    var url = "<?php echo base_url('employer/recruitment_interviews/send_notification_interview'); ?>";
    var data = {
  ...
  function scheduleInterview() {
    ...
    var url = "<?php echo base_url('employer/recruitment_interviews/schedule'); ?>";
    $.post(url, data, function(response) {
      var status = response.success;
      if (status) {
  ...
  $( "#btn-save-evaluations" ).click(function() {
