...
class Industries extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->Industry->record_count('tbl_job_industries');
		$config = pagination_configuration(base_url("admin/industries"), $total_rows, 25, 3, 5, true);
		...
		$obj_result = $this->Industry->get_all_records($config["per_page"], $page);
	...
	public function get_industries_by_id($id=''){
		if($id!=''){
			$row = $this->Industry->get_industries_by_id($id);
	...
	public function add(){
		...
		$this->Industry->add($industries_array);
	...
	public function update(){
		...
		$this->Industry->update($id, $industries_array);
	...
	public function delete($id=''){
		...
		$obj_row = $this->Industry->delete($id);
		echo 'done';
		exit;
	}
